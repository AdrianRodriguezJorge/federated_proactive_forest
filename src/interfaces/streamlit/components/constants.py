...
DATASET_PRESETS = {
    "Iris": {
        "file_path": "data/iris.csv", "target_column": "class", "test_size": 0.15,
        "scale": True, "sep": ",",
        "categorical_columns": [],
        "info": "150 muestras, 4 features, 3 clases (setosa, versicolor, virginica)",
    },
    "Letter": {
        "file_path": "data/letter.csv", "target_column": "class", "test_size": 0.15,
        "scale": True, "sep": ",",
        "categorical_columns": [],
        "info": "20,000 muestras, 16 features, 26 clases (A-Z)",
    },
    "Optdigits": {
        "file_path": "data/optdigits.csv", "target_column": "class", "test_size": 0.15,
        "scale": True, "sep": ",",
        "categorical_columns": [],
        "info": "5,620 muestras, 64 features (8x8 píxeles), 10 clases (0-9)",
    },
    "Spambase": {
        "file_path": "data/spambase.csv", "target_column": "class", "test_size": 0.15,
        "scale": True, "sep": ",",
        "categorical_columns": [],
        "info": "4,601 muestras, 57 features, 2 clases (spam/ham)",
    },
    "Nursery": {
        "file_path": "data/nursery.csv", "target_column": "class", "test_size": 0.15,
        "scale": True, "sep": ",",
    ...
    "Sonar": {
        "file_path": "data/sonar.csv", "target_column": "Class", "test_size": 0.15,
        "scale": True, "sep": ",",
        "categorical_columns": [],
        "info": "208 muestras, 60 features, 2 clases (Rock/Mine)",
    },
    "Vowel": {
        "file_path": "data/vowel.csv", "target_column": "Class", "test_size": 0.15,
        "scale": True, "sep": ",",
        "categorical_columns": [],
        "info": "990 muestras, 10 features, 11 clases",
    },
    "Car": {
        "file_path": "data/car.csv", "target_column": "class", "test_size": 0.15,
        "scale": True, "sep": ",",
    ...
    "CSV personalizado": {
        "file_path": "", "target_column": "class", "test_size": 0.15,
        "scale": True, "sep": ",",
        "categorical_columns": [],
