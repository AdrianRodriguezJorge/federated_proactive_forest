"""
Módulo para gestión de probabilidades de características en Proactive Forest.
"""
...
class FIProbabilityLedger(ProbabilityLedger):
    """
    Ledger basado en Feature Importance.
    Fórmula: p_new = p_old * (1 - FI_acumulado * alpha * rate)
    """
    ...
    def update_probabilities(self, new_tree, rate):
        ...
        self._probabilities = self._probabilities * (
            1 - (self._feature_importances / self._n_trees) * self._alpha * rate
        )
        self._normalize()
