...
class S6PerClientF1Strategy:
    """
    Strategy S6: Per-Client F1
    Each client selects its best trees by F1 macro score independently.
    """
    ...
    def aggregate(
        ...
        """
        Each client selects its best trees by F1 macro.
