...
def evaluate_global_pf_model(server_flex_model: FlexModel, test_data: Any, *args, **kwargs) -> Dict[str, float]:
    """
    ...
    try:
        # Compatibility check: if test_data is FLEX Dataset, convert to numpy
...
def evaluate_global_pf_model_at_clients(client_flex_model: FlexModel, client_data: Any, *args, **kwargs) -> Dict[str, float]:
    ...
    FLEX primitive (usually called via pool.map).
    """
